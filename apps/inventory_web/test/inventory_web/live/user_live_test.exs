defmodule InventoryWeb.UserLiveTest do
  ...
  @create_attrs %{confirmed_at: ~N[2010-04-17 14:00:00], email: "some email", hashed_password: "some hashed_password", password: "some password"}
  @update_attrs %{confirmed_at: ~N[2011-05-18 15:01:01], email: "some updated email", hashed_password: "some updated hashed_password", password: "some updated password"}
  @invalid_attrs %{confirmed_at: nil, email: nil, hashed_password: nil, password: nil}
